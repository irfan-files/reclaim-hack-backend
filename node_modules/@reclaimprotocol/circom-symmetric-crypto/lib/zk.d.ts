 ...
 */
export declare function generateZkWitness({ algorithm, privateInput: { key, }, publicInput: { ciphertext, iv, offset }, operator }: GenerateProofOpts): Promise<Uint8Array>;
/**
 ...
 * @param zkey
 */
export declare function verifyProof({ proof: { algorithm, plaintext, proofJson }, publicInput: { ciphertext, iv, offset }, operator, logger }: VerifyProofOpts): Promise<void>;
