...
async function _createClaimOnWitness({ name, params, secretParams, context, onStep, ownerPrivateKey, client: clientInit, logger = utils_1.logger, timestampS, ...zkOpts }) {
