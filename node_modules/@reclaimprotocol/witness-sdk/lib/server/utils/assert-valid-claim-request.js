...
const verify_server_certificates_1 = require("./verify-server-certificates");
/**
...
async function assertValidClaimRequest(request, metadata, logger) {
    ...
    const receipt = await decryptTranscript(request.transcript, logger, zkEngine === api_1.ZKProofEngine.ZK_ENGINE_GNARK ? 'gnark' : 'snarkJS');
    ...
    await (0, verify_server_certificates_1.verifyServerCertificates)(receipt, logger);
