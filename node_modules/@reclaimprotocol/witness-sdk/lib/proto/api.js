...
exports.TunnelDisconnectEvent = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.error !== undefined) {
            exports.WitnessErrorData.encode(message.error, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.ClaimTunnelResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.error !== undefined) {
            exports.WitnessErrorData.encode(message.error, writer.uint32(26).fork()).join();
        }
        if (message.signatures !== undefined) {
...
exports.RPCMessage = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.initResponse !== undefined) {
            exports.Empty.encode(message.initResponse, writer.uint32(26).fork()).join();
        }
        if (message.connectionTerminationAlert !== undefined) {
            exports.WitnessErrorData.encode(message.connectionTerminationAlert, writer.uint32(34).fork()).join();
        }
        if (message.requestError !== undefined) {
            exports.WitnessErrorData.encode(message.requestError, writer.uint32(42).fork()).join();
        }
